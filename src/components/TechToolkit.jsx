    ...
    <section id="toolkit" className="relative py-16">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {tools.map((t) => (
            <div key={t.name} className="group rounded-2xl border border-emerald-900/70 bg-slate-900/60 p-5 shadow-sm backdrop-blur transition hover:shadow-[0_12px_30px_-12px_rgba(16,185,129,0.45)]">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-900 to-sky-900 text-emerald-200 ring-1 ring-emerald-800">
                ...
                <div>
                  <h3 className="font-medium text-emerald-100">{t.name}</h3>
